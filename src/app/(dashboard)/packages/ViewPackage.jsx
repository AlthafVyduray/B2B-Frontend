        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl border border-gray-200 flex flex-col max-h-[90vh]">
            <CardContent className="px-10 p-6 overflow-y-auto">
                ...
                <div>
                    ...
                    <p>Departure: {selectedPackage.departure}</p>
                </div>
                    ...
                    {packages.some(pkg => pkg._id === selectedPackage._id) ? (
                        ...
                        <div className="text-small text-blue-600">
                            <p>Adult: ${selectedPackage?.pricing?.adult.toLocaleString()}</p>
                            <p>Child With Bed: ${selectedPackage?.pricing?.childWithBed.toLocaleString()}</p>
                            <p>Child Without Bed: ${selectedPackage?.pricing?.childWithoutBed.toLocaleString()}</p>
                            <p>Infant: ${selectedPackage?.pricing?.infant.toLocaleString()}</p>
                        </div> 
                    )} 
