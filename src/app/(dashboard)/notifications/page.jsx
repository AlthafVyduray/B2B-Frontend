      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="p-6 space-y-6 bg-gray-50">
          <div className="flex items-center justify-between mb-8">
            ...
            <Button
              onClick={() => setNotificationToCreate(true)}
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex-shrink-0">
                        {(notification.type === "success" ||
                          ...
                          `Booking ID :  ${notification.booking}`}
                      </div>
          ...
          <div className="flex justify-center items-center gap-2 mt-6">
            ...
            {Array.from(
              { length: notificationPagination.totalPages || 1 },
              (_, i) => i + 1
            )
              .filter(
                (p) =>
            ...
            <Button
              ...
              onClick={() =>
                setPage((p) =>
                  Math.min(notificationPagination.totalPages || 1, p + 1)
                )
              }
            >
              Next
          ...
          <div className="bg-white w-full max-w-md rounded-lg shadow-xl relative border border-gray-200">
            ...
            <div className="w-full max-w-4xl bg-white shadow-lg rounded-xl p-6 transform transition-all hover:shadow-2xl">
              ...
              <input
                ...
                onChange={(e) =>
                  setNotification((pre) => ({ ...pre, title: e.target.value }))
                }
                placeholder="title"
