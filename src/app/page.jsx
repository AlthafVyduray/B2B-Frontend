      ...
      <section className='bg-[url("/images/1.jpg")] bg-cover bg-center h-screen border rounded-4xl lg:m-10 m-4'>
        <div className='w-full h-full grid lg:grid-cols-2 px-4 sm:px-6 md:px-10 lg:px-20 relative'>
          ...
          <div className='absolute  bottom-10 left-1/2 -translate-x-1/2 lg:translate-x-0 lg:left-2/3 lg:right-20 lg:top-1/2 w-[90%] sm:w-[80%] lg:w-auto flex justify-center lg:justify-end'>
            <div className="bg-white/90 lg:bg-transparent p-6 sm:p-8 lg:p-0 rounded-xl lg:rounded-none shadow-lg lg:shadow-none text-slate-700 text-center lg:text-left">
              ...
              <p className="mt-4 text-xs sm:text-sm md:text-base text-slate-600 max-w-xl mx-auto lg:mx-0">
                B2B Hyderabad Travel Agency – your one-stop portal for seamless bookings, tours, and travel solutions in the City of Pearls.
              </p>

              <button className="mt-6 inline-flex items-center gap-3 text-sm font-semibold uppercase tracking-wide">
                <Link href={"/booking"} className="px-4 py-2 border border-slate-800 rounded-md">
                  Get Started
                </Link>
