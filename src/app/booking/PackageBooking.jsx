...
const PackageBooking = ({
  ...
  //default Package
  const incdefault = (field) =>
    changeDefaultField(field, Number(defaultPackageForm[field] || 0) + 1);
  const decdefault = (field, min = 0) =>
    changeDefaultField(
      field,
      Math.max(min, Number(defaultPackageForm[field] || 0) - 1)
    );
  const changeDefaultField = (name, value) =>
    setDefaultPackageForm((p) => ({ ...p, [name]: value }));
  ...
  (defaultPackages || []).forEach((p) =>
    allPackagesMap.set(p._id, { ...p, __group: "default" })
  );
  (packages || []).forEach((p) => {
    if (!allPackagesMap.has(p._id))
      allPackagesMap.set(p._id, { ...p, __group: "regular" });
  });
    ...
    <Card className="max-h-[900px]">
      ...
      <CardContent className="space-y-4 flex flex-col">
        <div className="space-y-2 w-full">
          ...
          <Select
            value={
              defaultPackage ? defaultPackageForm.package_id : form.package_id
            }
            onValueChange={(value) => {
          ...
          <>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Railway Station">
                        Railway Station
                      </SelectItem>
                  ...
                  {form.pickup_location === "Other" && (
                    <div className="space-y-2">
                      <div>
                        <Input
                          type="text"
                          id="pickup_location_other"
                          name="pickup_location_other"
                          value={form.pickup_location_other}
                          onChange={(e) =>
                            changeField("pickup_location_other", e.target.value)
                          }
                        />
                      </div>
                  ...
                  {form.drop_location === "Other" && (
                    <div className="space-y-2">
                      <div>
                        <Input
                          type="text"
                          id="drop_location_other"
                          name="drop_location_other"
                          value={form.drop_location_other}
                          onChange={(e) =>
                            changeField("drop_location_other", e.target.value)
                          }
                        />
                      </div>
                      {errors.pickup_location_other && (
                        <div className="text-xs text-red-600 mt-1">
                          {errors.drop_location_other}
                        </div>
                      )}
                    </div>
                  )}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <span className="capitalize font-medium">Adults(12+)</span>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <span className="capitalize font-medium">Children (2-11)</span>
                <div className="flex items-center gap-3">
                  <Button
                    variant="outline"
                    size="sm"
