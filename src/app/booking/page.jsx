...
export default function TravelBookingApp() {
  ...
  const perHeadAll =
    totalPeople > 0
      ? safeNum(form.total_amount) / totalPeople
      : safeNum(form.total_amount);
  const perHeadAdults =
    safeNum(form.adults_total) > 0
      ? safeNum(form.total_amount) / safeNum(form.adults_total)
      : safeNum(form.total_amount);
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (
        payload.pickup_location === "Other" &&
        (payload.pickup_location_other ?? "").trim()
      ) {
        payload.pickup_location = payload.pickup_location_other.trim();
      }
      if (
        payload.drop_location === "Other" &&
        (payload.drop_location_other ?? "").trim()
      ) {
  ...
  const validatePackage = (values) => {
    const e = {};
    if (!values.client_name) e.client_name = "client name is required";
    if (!values.client_email) e.client_email = "client email is required";
    if (!values.client_phone) e.client_phone = "client number is required";
    ...
    if (Number(values.adults_total) < 1)
      e.adults_total = "At least 1 adult required.";
    return e;
  };
  ...
  useEffect(() => {
    ...
    if (defaultPackage) {
      ...
      const pkg = defaultPackages.find(
        (p) => p._id === defaultPackageForm.package_id
      );
      if (pkg) {
        ...
        if (defaultPackageForm.children_with_bed) {
          total +=
            pkg.pricing.childWithBed * defaultPackageForm.children_with_bed;
        }
      ...
      if (price) {
        if (form.entry_ticket_needed) {
          total +=
            price.entryAdult * form.adults_total +
            price.entryChild * form.children;
        }
        if (form.snow_world_needed) {
          total +=
            price.snowAdult * form.adults_total +
            price.snowChild * form.children;
        }
      ...
      if (form.hotel_id) {
        ...
        if (hotel) {
          ...
          if (form.rooms) {
            setHotelPrice(
              (prev) => prev + hotel.pricing.roomPrice * form.rooms * nights
            );
          ...
          if (form.extra_beds) {
            setHotelPrice(
              (prev) =>
                prev + hotel.pricing.extraBedPrice * form.extra_beds * nights
            );
        ...
        <Tabs value={tab} onValueChange={setTab} className="w-full">
          ...
          <div>
            <div className="lg:col-span-3">
              <div className="gap-3 grid md:grid-cols-3 mb-3 md:mb-5 mx-3">
                <div className="flex flex-col gap-2">
                  ...
                  <div>
                    <Input
                      ...
                      value={
                        defaultPackage
                          ? defaultPackageForm.client_name
                          : form.client_name
                      }
                      onChange={
                        defaultPackage
                          ? (e) =>
                              setDefaultPackageForm((p) => ({
                                ...p,
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div>
                    <Input
                      ...
                      value={
                        defaultPackage
                          ? defaultPackageForm.client_email
                          : form.client_email
                      }
                      onChange={
                        defaultPackage
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div>
                    <Input
                      ...
                      value={
                        defaultPackage
                          ? defaultPackageForm.client_phone
                          : form.client_phone
                      }
                      onChange={
                        defaultPackage
              ...
              >
                ...
                <PackageBooking
                  ...
                  form={form}
                  setForm={setForm}
                  defaultPackageForm={defaultPackageForm}
                  setDefaultPackageForm={setDefaultPackageForm}
                  errors={errors}
                  ...
                  {defaultPackage ? (
                    <CardContent className="space-y-6">
                      <div className="border rounded-lg p-4">
                        ...
                        <div className="flex flex-col">
                          <p>Clinet Name: {defaultPackageForm.client_name}</p>
                          <p>Clinet Email: {defaultPackageForm.client_email}</p>
                          <p>Clinet Phone: {defaultPackageForm.client_phone}</p>
                        </div>
                      </div>
                      {selectedPackage ? (
                        <>
                            ...
                            <div className="flex justify-between items-center">
                              <div>
                                <p className="font-medium mb-3">
                                  {defaultPackageForm.package_name}
                                </p>
                                <div className="mb-3">
                                  <p>Pickup:</p>
                                  <p className="font-medium">
                                    pickup date:{" "}
                                    {defaultPackageForm.pickup_date
                                      ? defaultPackageForm.pickup_date
                                      : "--Not Selected--"}
                                  </p>
                                  <p>Drop:</p>
                          ...
                          <div className="border rounded-lg p-4">
                            ...
                            <div className="flex flex-col gap-4">
                              {selectedPackage?.itineraries?.map(
                                (item, index) => (
                                  <div
                                    key={item.id ?? index}
                                  ...
                                  >
                                    {/* Left: image */}
                                    <div
                                      className="relative w-full md:w-1/3 h-48 rounded-md flex-shrink-0 bg-cover bg-center"
                                      style={{
                                        backgroundImage: `url(${
                      ...
                      <div className="border rounded-lg p-4">
                        ...
                        <div className="space-y-1">
                          {defaultPackageForm.adults_total > 0 && (
                            <p>Adults: {defaultPackageForm.adults_total}</p>
                          )}
                          ...
                          {defaultPackageForm.infants > 0 && (
                            <p>Infants: {defaultPackageForm.infants}</p>
                          )}
                        </div>
                      </div>
                          ...
                          <div className="space-y-2">
                            ...
                            {defaultPackageForm.children_with_bed > 0 && (
                              <div className="grid grid-cols-3 text-sm">
                                ...
                                <span className="text-center">
                                  {defaultPackageForm.children_with_bed} ×{" "}
                                  {selectedPackage?.pricing?.childWithBed}
                                </span>
                                <span className="text-right font-medium">
                                  {defaultPackageForm.children_with_bed *
                                    selectedPackage?.pricing?.childWithBed}
                            ...
                            {defaultPackageForm.children_without_bed > 0 && (
                              <div className="grid grid-cols-3 text-sm">
                                ...
                                <span className="text-center">
                                  {defaultPackageForm.children_without_bed} ×{" "}
                                  {selectedPackage?.pricing?.childWithoutBed}
                                </span>
                                <span className="text-right font-medium">
                                  {defaultPackageForm.children_without_bed *
                                    selectedPackage?.pricing?.childWithoutBed}
                            ...
                            {defaultPackageForm.infants > 0 && (
                              <div className="grid grid-cols-3 text-sm">
                                ...
                                <span className="text-center">
                                  {defaultPackageForm.infants} ×{" "}
                                  {selectedPackage?.pricing?.infant}
                                </span>
                                <span className="text-right font-medium">
                                  {defaultPackageForm.infants *
                                    selectedPackage?.pricing?.infant}
                        ...
                        <div className="flex-1 space-y-3">
                          ...
                          {showAgentMarkup && (
                            <div className="flex items-center gap-2">
                              <input
                                ...
                                value={markupPercent}
                                onChange={(e) =>
                                  handleDefaultPackageAgentMarkupChange(
                                    e.target.value
                                  )
                                }
                                placeholder="Enter %"
                          ...
                          {showAgentMarkup && (
                            <p className="text-gray-700">
                              Agent Commission: ₹
                              {(
                                defaultPackageForm.agent_commission ?? 0
                              ).toFixed(2)}
                            </p>
                          )}
                          ...
                          <p className="font-bold text-lg text-gray-900">
                            Total Amount: ₹
                            {(defaultPackageForm.total_amount ?? 0).toFixed(2)}
                          </p>
                        </div>
                    ...
                    <CardContent className="space-y-6">
                      {selectedPackage ? (
                        <>
                          <div className="border rounded-lg p-4">
                            ...
                            <div className="flex flex-col">
                              <p>
                                Clinet Name: {form.client_name}
                              </p>
                              <p>
                                Clinet Email: {form.client_email}
                              </p>
                              <p>
                                Clinet Phone: {form.client_phone}
                              </p>
                            </div>
                          </div>
                          <div className="border rounded-lg p-4">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span className="font-bold text-primary">
                                ...
                                {selectedPackage.price *
                                  (form.adults_total + form.children)}
                              </span>
                            </div>
                          </div>
                          <div className="border rounded-lg p-4">
                      ...
                      <div className="border rounded-lg p-4">
                        ...
                        <div className="space-y-1">
                          {form.adults_total > 0 && (
                            <p>Adults: {form.adults_total}</p>
                          )}
                          {form.children > 0 && (
                            <p>Children: {form.children}</p>
                          )}
                          ...
                          <div className="flex justify-between items-center">
                            <div>
                              ...
                              <div className="flex items-center gap-1">
                                {[...Array(selectedHotel.starRating)].map(
                                  (_, i) => (
                                    <span
                                      key={i}
                              ...
                              <p className="font-medium">
                                Extra Beds:{" "}
                                {form.extra_beds ? form.extra_beds : "0"}
                              </p>
                              <p className="font-medium">
                                Food Plan: {form.food_plan && form.food_plan}
                              </p>
                            </div>
                            <span className="font-bold text-primary">
                              ₹{hotelPrice}
                          ...
                          <div className="flex justify-between items-center">
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                {form.vehicle_name && selectedVehicle
                            ...
                            <span className="font-bold text-primary">
                              {form.vehicle_name &&
                                ...
                                selectedPackage &&
                                `₹${
                                  selectedVehicle.price * selectedPackage.days
                                }`}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center">
                          <div>
                            <p className="text-sm">
                              Extra Food:{" "}
                              <span>
                                {form.extra_food?.breakfast && "Breakfast,"}
                              </span>{" "}
                              <span>
                                {form.extra_food?.lunchNonVeg && "lunchNonVeg,"}
                              </span>{" "}
                              <span>
                                {form.extra_food?.lunchVeg && "lunchVeg"}
                              </span>{" "}
                            </p>
                            <p className="text-sm">
                              Guide Needed: {form.guideNeeded ? "Yes" : "No"}
                            </p>
                            <p className="text-sm">
                              Entry ticket :{" "}
                              {form.entry_ticket_needed ? "Yes" : "No"}
                            </p>
                            <p className="text-sm">
                              Snow world ticket :{" "}
                              {form.snow_world_needed ? "Yes" : "No"}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="border-t pt-4">
                        <div className="flex-1 space-y-3">
                          ...
                          {showAgentMarkup && (
                            <div className="flex items-center gap-2">
                              <input
                                ...
                                value={markupPercent}
                                onChange={(e) =>
                                  handleAgentMarkupChange(e.target.value)
                                }
                                placeholder="Enter %"
                                min="0"
                                step="0.01"
                          ...
                          {showAgentMarkup && (
                            <p className="text-gray-700">
                              Agent Commission: ₹
                              {(form.agent_commission ?? 0).toFixed(2)}
                            </p>
                          )}
                          ...
                          {splitMode === "all" ? (
                            <p className="font-bold text-lg text-gray-900">
                              Per Head Amount: ₹
                              {Number(perHeadAll ?? 0).toFixed(2)}
                            </p>
                          ) : (
                            <p className="font-bold text-lg text-gray-900">
                              Per Head Amount (Adults Only): ₹
                              {Number(perHeadAdults ?? 0).toFixed(2)}
                            </p>
                          )}
                        </div>
                        <p className="text-sm text-muted-foreground mt-1">
